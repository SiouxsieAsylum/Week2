...
class Course
  attr_accessor :name :department :credits :students :student
  def initialize (name,department,credits,student, students = [])
      @name = name
    ...
    def add_student
      #relies on student.enroll
      #students << student
      #be sure it only adds once
      #i.e. unless students.include? student
    end
end
